...
MC.UI = {
  ...
  // ===== Hero 区块 -- no stats template, no badge dot, no gradient text =====
  renderHero() {
    ...
    return `<section class="hero">
      <div class="hero-inner app-container">
        ...
        <h1 class="hero-title">
          发现并分享<br><span class="highlight">Minecraft 存档</span>
        </h1>
        <p class="hero-subtitle">
          浏览来自全球玩家的生存、建筑、红石存档。已有 ${totalArchives} 个存档，${totalUsers} 位社区成员。
        </p>
