...
/**
 * 收藏记录实体 — 存储 user 和 archive 的收藏关系
 */
@Entity
@Table(name = "bookmarks", uniqueConstraints = @UniqueConstraint(columnNames = {"user_id", "archive_id"}))
public class BookmarkRecord {
    ...
    public BookmarkRecord(User user, Archive archive) {
        this.user = user;
